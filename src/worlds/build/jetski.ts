...
export class Jetski extends World {
  ...
  public override async init(): Promise<void> {
    ...
    this._carbuild = await Carbuild.create(this, this._building, displayPosition, Shelf_Sound, GetBrick_Sound, PlaceBrick_Sound, Rotate_Sound, colorControls, decalControls, 'jetski', Build_Anim0, Build_Anim1, Build_Anim2)
