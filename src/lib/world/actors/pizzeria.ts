...
export class Pizzeria extends Actor {
  ...
  public get pizzaMissionActive(): boolean {
  ...
  public override async init(): Promise<void> {
    this.isle.boundaryManager.onTrigger((name, data, _direction, roi) => {
      ...
      if (
        (name[2] === 'S' && data === 0x12e && engine.currentSaveGame.player === 'pepper') ||
        (name[2] === 'C' &&
          (((data === 0x24 || data === 0x22) && engine.currentSaveGame.player === 'mama') || (data === 0x33 && engine.currentSaveGame.player === 'papa') || ((data === 0x08 || data === 0x09) && engine.currentSaveGame.player === 'nick') || (data === 0x0b && engine.currentSaveGame.player === 'laura'))) ||
        (name[2] === 'W' && data === 0x169 && engine.currentSaveGame.player === 'nick')
      ) {
  ...
  public override update(_delta: number): { from: THREE.Vector3; to: THREE.Vector3 } | null {
